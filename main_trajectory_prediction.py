...
import sys
from trajectory_prediction.src.bicycle_PINN import Difference_RNN,PINN_Difference_RNN,Non_Linear_Difference_RNN
...
if __name__=="__main__":
    ...
    if model_type == 'non_linear_continuous':
        ...
        model = Non_Linear_Difference_RNN(input_size,hidden_size,len(matrix_A_shape))
