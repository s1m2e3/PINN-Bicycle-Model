...
class GRU(nn.Module):
    def __init__(self,input_size,hidden_size,output_size,num_layers):
        ...
        self.gru = nn.GRU(input_size,output_size,num_layers).double().to(self.device)
        # self.linear = nn.Linear(output_size,output_size).double().to(self.device)
